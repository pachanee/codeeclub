...
export const submissionCreate: unknown = functions.runWith({ timeoutSeconds: 540 }).firestore.document(`${SUBMISSION_JOBS}/{submissionId}`).onCreate(onCreateSubmission)
