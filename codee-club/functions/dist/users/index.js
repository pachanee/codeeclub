...
const onUpdateUser = (change, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const profileUpdated = dataBefore.bio !== dataAfter.bio || [...new Set([...(0, object_extensions_1.keys)(dataBefore.links), ...(0, object_extensions_1.keys)(dataAfter.links)])].some(key => dataBefore.links[key] !== dataAfter.links[key]);
    if (profileUpdated)
        yield (0, notifications_1.notify)(dataAfter.followerIds, (0, notifications_1.notificationProfileUpdated)(now, context.params.userId, dataAfter));
    ...
    if (addedFollowingIds.length > 0)
        yield (0, notifications_1.notify)(addedFollowingIds, (0, notifications_1.notificationNewFollower)(now, context.params.userId, dataAfter));
});
