...
exports.submissionCreate = firebase_functions_initialized_1.default.runWith({ timeoutSeconds: 540 }).firestore.document(`${dao_1.SUBMISSION_JOBS}/{submissionId}`).onCreate(new_submission_1.onCreateSubmission);
