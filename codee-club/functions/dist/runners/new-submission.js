...
const onCreateSubmission = (snapshot, _context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const problemCount = (0, object_extensions_1.length)(activity === null || activity === void 0 ? void 0 : activity.problems);
    ...
    const inputs = (0, mapValues_1.default)(tests, 'input');
    const data = { inputs, sourceRefs: submission.fileRefs };
    const token = yield (0, get_token_1.getToken)(runner.url);
    const headers = { Authorization: `Bearer ${token}` };
    let response;
    try {
        response = yield (0, get_post_1.post)({
            url: runner.url,
            headers,
            data,
            timeout: 301000
    ...
    const testResults = (0, object_extensions_1.keys)(tests).map((testId) => {
        var _a, _b, _c;
    ...
    try {
        yield db.runTransaction((t) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const firstBestProblemResultIds = (0, object_extensions_1.keys)(allProblemResults).filter((prId) => allProblemResults[prId].isFirstBest);
