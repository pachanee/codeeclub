...
module.exports = {
  ...
  rules: {
    ...
    'no-restricted-imports': ['error', { patterns: ['@codee-club/common/src/**/*'] }],
    ...
    'simple-import-sort/imports': [
      ...
      {
        groups: [
          ['^(@(?!codee-club))?\\w'], // Packages (start with a letter, digit, underscore, or `@` followed by a letter)
          ['^@codee-club'], // Our packages
    ...
    'unicorn/no-null': 'off', // TODO: Enable this
